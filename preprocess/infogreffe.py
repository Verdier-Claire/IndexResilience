...
class Preprocess():
    def __init__(self):
        ...
        self.conn_iat = psycopg2.connect(
           user = "iat",
           password = "bR3fTAk2VkCNbDPg",
           host = "localhost",
           port = "5432",
...
def main():
    ...
    # create table for each year to 2022
    Infogreffe().get_2022(liste_data)
    print("Fin des get 2022")
    ...
    list_activity = Preprocess().select_activity()
    ...
    # join chiffre clé 2018 with chiffre clé 2019 and with chiffre clé 2020
    # infogreffe_only_2first : 2018 join 2019 , infogreffe_first_year_comp : join 2018 - 2019 -2020
    ...
    # join chiffre clé 2019 with chiffre clé 2020 and with chiffre clé 2021
    # infogreffe_only_2first : 2019 join 2020 , infogreffe_first_year_comp : join 2019 - 2020 -2021
    ...
    Preprocess().get_2019_2020(infogreffe_middle_year_comp)
